  ...
  return (
    <div className={styles.pipelineContainer}>
      <h3>
        ...
        Pipeline de Traitement des Pénalités
      </h3>
      ...
      <div className={styles.steps}>
        <div className={`${styles.step} ${styles.danger}`}>
          ...
          <span className={styles.amount}>{detectees.toLocaleString()} €</span>
        </div>
        
        <div className={`${styles.step} ${styles.active}`}>
          <div className={styles.circle}>2</div>
          <span className={styles.label}>En Contestation</span>
          <span className={styles.amount}>{contestees.toLocaleString()} €</span>
        </div>
        
        <div className={`${styles.step} ${styles.success}`}>
          <div className={styles.circle}>3</div>
          <span className={styles.label}>Validées (Facturation)</span>
          <span className={styles.amount}>{validees.toLocaleString()} €</span>
        </div>
      </div>
    </div>
  );
