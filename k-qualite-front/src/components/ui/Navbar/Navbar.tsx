    ...
    <nav className={styles.navbar}>
      ...
      <div className={styles.navLinks}>
        ...
        {!user?.mustChangePassword && user?.role === 'PARTENAIRE' && (
            ...
            <Link href="/cq-partenaire" className={`${styles.navItem} ${pathname === '/cq-partenaire' ? styles.active : ''}`}>Indicateurs CQ</Link>
          </>
        )}
        ...
        {!user?.mustChangePassword && user?.role === 'ADMIN' && (
            ...
            <Link href="/admin/cq-data" className={`${styles.navItem} ${pathname === '/admin/cq-data' ? styles.active : ''}`}>Données CQ</Link>
            <Link href="/admin/erreurs" className={`${styles.navItem} ${pathname === '/admin/erreurs' ? styles.active : ''}`}>Toutes les Erreurs</Link>
